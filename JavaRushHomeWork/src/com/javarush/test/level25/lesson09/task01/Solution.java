...
public class Solution extends Thread
{
    public Solution()
    {
        setUncaughtExceptionHandler(new UncaughtExceptionHandler()
        {
            ...
            {
                if (e.toString().contains("Exception")) // или if (e instanceof Exception)
                {
                    System.out.println("Надо обработать");
                } else if (e.toString().contains("Error")) // или if (e instanceof Error)
                {
                    System.out.println("Нельзя дальше работать");
                } else if (e.toString().contains("Throwable")) // или if (e instanceof Throwable)
                {
