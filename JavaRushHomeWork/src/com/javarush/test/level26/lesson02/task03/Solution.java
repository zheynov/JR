...
public class Solution
{
    ...
    {
        private ArrayList<Comparator<T>> listNew = new ArrayList<>();

        public CustomizedComparator(Comparator<T>... list)
        {
            Collections.addAll(listNew, list);
        }
        ...
        public int compare(T o1, T o2)
        {
            ...
            for (Comparator<T> aListNew : listNew)
            {
                vvvv = aListNew.compare(o1, o2);
                if (vvvv != 0) return vvvv;
            }
